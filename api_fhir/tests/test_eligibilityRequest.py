...
class EligibilityRequestConverterTestCase(EligibilityRequestTestMixin):
    ...
    def set_up(self):
        super(EligibilityRequestConverterTestCase, self).set_up()
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self._test_test_eligibility_response_json_representation = open(dir_path
                                                                        + self.__TEST_ELIGIBILITY_RESPONSE_JSON_PATH) \
            .read()
        self._test_test_eligibility_request_json_representation = open(dir_path
    ...
    def test_create_object_from_json(self):
        self.set_up()
        fhir_eligibility_response = FHIRBaseObject.loads(self._test_test_eligibility_response_json_representation,
                                                         'json')
        self.verify_fhir_instance(fhir_eligibility_response)
    ...
    def test_fhir_object_to_json_request(self):
        ...
        self.assertEqual(self._test_test_eligibility_request_json_representation, actual_representation)
    ...
    def test_fhir_object_to_json_response(self):
        ...
        self.assertEqual(self._test_test_eligibility_response_json_representation, actual_representation)
